...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitMinima Core bitminima-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitminima-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitminima transaction") + "\n" +
              "  bitminima-tx [options] -create [commands]   " + _("Create hex-encoded bitminima transaction") + "\n" +
              "\n";
